...
('cien años de soledad', 1, 'masculino', 5, 'estante a-1'),
('don quijote de la mancha', 2, 'masculino', 3, 'estante b-2'),
('la casa de los espíritus', 3, 'femenino', 4, 'estante c-3'),
('la ciudad y los perros', 4, 'masculino', 2, 'estante d-4'),
('como agua para chocolate', 5, 'femenino', 6, 'estante a-2');
